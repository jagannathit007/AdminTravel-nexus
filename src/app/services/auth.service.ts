...
export type DmcListResponse = DMCList[];
...
export class DmcListService {
  ...
  async getAllDmcLists(): Promise<DmcListResponse> {
    try {
      this.getHeaders();
      const response = await this.apiManager.request(
        {
          url: apiEndpoints.GET_DMC_LISTS,
          method: 'GET',
        },
        null,
        this.headers
      ...
      console.error('API Error:', error);
      swalHelper.showToast('Failed to fetch DMC lists', 'error');
      throw error;
    }
  }

  async createDmcList(data: { title: string }): Promise<any> {
    try {
      this.getHeaders();
      const response = await this.apiManager.request(
        {
          url: apiEndpoints.CREATE_DMC_LIST,
          method: 'POST',
        },
        data,
        this.headers
      ...
      console.error('API Error:', error);
      swalHelper.showToast('Failed to create DMC list', 'error');
      throw error;
    }
  }

  async updateDmcList(id: string, data: { title: string }): Promise<any> {
    try {
      this.getHeaders();
      const response = await this.apiManager.request(
        {
          url: `${apiEndpoints.UPDATE_DMC_LIST}/${id}`,
          method: 'PUT',
        },
        data,
        this.headers
      ...
      console.error('API Error:', error);
      swalHelper.showToast('Failed to update DMC list', 'error');
      throw error;
    }
  }

  async deleteDmcList(id: string): Promise<any> {
    try {
      this.getHeaders();
      const response = await this.apiManager.request(
        {
          url: `${apiEndpoints.DELETE_DMC_LIST}/${id}`,
          method: 'DELETE',
        },
        {},
        this.headers
      ...
      console.error('API Error:', error);
      swalHelper.showToast('Failed to delete DMC list', 'error');
      throw error;
    }
  }
}
